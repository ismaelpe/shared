...
class ServicesCatalogQueueHandler extends AbstractQueueHandler implements Serializable {
    ...
    static final String SCU_SERVICES_CATALOG_REPO_URL = "https://git.svb.digitalscale.es/cbk/alm/services/documentation/services-catalog.git"
    static final String SCU_GIT_REPO_PATH = "services-catalog-git-repo"
    //static final String SCU_JOB_URL = "http://buildasp07.digitalscale.es:8090/job/alm/job/services/job/arch/job/alm/job/job-services-catalog-updater/build?token=EDTLz6zHeUtyc5yUXZdAnR7BqtA7unuW"
