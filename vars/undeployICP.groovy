...
def call(PomXmlStructure pomXml, PipelineData pipeline, String environment, boolean ignoreExistingAncient, boolean forceAllCenters) {
	...
	/*
     ...
     envVars:[[name:ABSIS_APP_ID, value:demoPipelineMicr], [name:ABSIS_CENTER_ID, value:1], [name:ABSIS_APP_TYPE, value:SRV.MS], [name:ABSIS_ENVIRONMENT, value:dev], [name:ABSIS_APP_DOMAIN, value:null], [name:ABSIS_APP_SUBDOMAIN, value:NO_SUBDOMAIN], [name:ABSIS_APP_COMPANY, value:null], [name:JAVA_OPTS, value:-Dspring.cloud.config.failFast=true], [name:nonProxyHosts, value:*.cxb-ab3cor-dev|*.cxb-ab3app-dev|*.api.tst.internal.cer.caixabank.com|*.api.pre.internal.cer.caixabank.com|*.api.pro.internal.cer.caixabank.com], [name:http.additionalNonProxyHosts, value:cxb-ab3cor-dev,cxb-ab3app-dev,api.tst.internal.cer.caixabank.com,api.pre.internal.cer.caixabank.com,api.pro.internal.cer.caixabank.com], [name:NO_PROXY, value:cxb-ab3cor-dev], [name:ABSIS_BLUE_GREEN, value:B], [name:CF_INSTANCE_INDEX, value:1], [name:SPRING_PROFILES_ACTIVE, value:cloud,dev,icp,icpdev], [name:ABSIS_ICP_ENVIRONMENT, value:dev]]]], 
     absis:[app:[loggingElkStack:absis30, replicas:1, instance:demoPipelineMicr1, name:demoPipelineMicr], resources:[requests:[memory:128Mi, cpu:50m], limits:[memory:512Mi, cpu:450m]], 
            apps:[envQualifier:[stable:[id:demopipelinemicr1-b, colour:B, image:pro-registry.pro.caas.caixabank.com/containers/ab3app/demopipelinemicr1:1.73.0-SNAPSHOT-A, version:1.73.0-SNAPSHOT, stable:false, new:false, replicas:1, requests_memory:128Mi, requests_cpu:50m, limits_memory:512Mi, limits_cpu:450m]]], 
