...
class CicsHISCreateRCResultPipelineData extends CicsHISProvisioningResultPipelineData {
    ...
    CicsHISCreateRCResultPipelineData(String gitUrl) {
        super(gitUrl)
    }
