...
class MaximoFalloSSLErrorWhileExecutingMavenGoal extends MaximoAbstractFallo {
    ...
    MaximoFalloSSLErrorWhileExecutingMavenGoal(String environment, def log) {
        ...
        this.resumen = "Fallo de conectividad SSL al ejecutar maven en un agente Jenkins corriendo en Cloud"
        this.descripcion =
                "<p>Se han producido diversos errores de conectividad SSL durante una ejecución maven en el JaaS que corre en Cloud a las ${new Date().toString()}.</p>" +
        ...
        this.pipelineExceptionErrorMessage =
            "Fallo de conectividad SSL al ejecutar maven en un agente Jenkins corriendo en Cloud.\n" +
