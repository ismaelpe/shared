...
class CGSPipelineStructure extends PipelineStructure {


    CGSPipelineStructure(String pipelineId) {
        super(pipelineId, "CGS_Pipeline")
    }
    ...
    def getStages() {
        return [
                ...
                [id       : pipelineId + "010",
                 estado   : "inactive",
                 nombre   : "010-getting-last-committed-cgs-file",
                 resultado: "",
                 orden    : 0
                ],
                [id       : pipelineId + "011",
                ...
                [id       : pipelineId + "150",
                 estado   : "inactive",
                 nombre   : "150-create-operation-model",
                 resultado: "",
                 orden    : 0
                ],
                [id       : pipelineId + "250",
