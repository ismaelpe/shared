...
class CloudStressDeployment {
	...
	CloudStressDeployment(String groupId, String artifactId, String version, String classifier, String center, String environment, String timestamp){
