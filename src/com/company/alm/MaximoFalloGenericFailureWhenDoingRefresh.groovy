...
class MaximoFalloGenericFailureWhenDoingRefresh extends MaximoAbstractFallo {
    ...
    MaximoFalloGenericFailureWhenDoingRefresh(String environment, String url, def log) {
        ...
        this.resumen = "Fallo genérico de conectividad al hacer refresh de micros en ICP"
        this.descripcion =
                "<p>Se han producido diversos errores al intentar hacer un refresh de micros desplegados en ICP a las ${new Date().toString()}.</p>" +
        ...
        this.pipelineExceptionErrorMessage =
            "Fallo de refresh de micros en ICP.\n" +
